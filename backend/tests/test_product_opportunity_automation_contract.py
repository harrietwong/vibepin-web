...
CURRENT_MANIFEST_PATH = (
    ROOT / "docs" / "product_opportunities_v37_release_manifest_9a22c16.json"
)
...
def test_current_product_only_release_pointer_and_manifest_are_exact() -> None:
    ...
    manifest_name = "product_opportunities_v37_release_manifest_9a22c16.json"
    ...
    assert manifest["postgresCanaryCommit"] == (
        "a299a17dae428dae69d55f4262f5301804fb35e7"
    )
    assert manifest["liveManifestVerifierFixCommit"] == functional
