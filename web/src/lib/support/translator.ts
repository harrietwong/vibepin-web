...
/** Optional — enables best-effort internal cost logging (never affects the call). */
 ...
 * cannot add latency to or fail the translation.
 */
...
async function callChatJson(
  system: string,
  userPrompt: string,
  costContext?: TranslatorCostContext,
): Promise<string | null> {
