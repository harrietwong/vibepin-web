...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    shortAnswer:
      "Publishing usually fails because Pinterest isn't connected (or the connection expired), no board is selected, or the Pin has no usable image. Title, description, alt text, and destination link are recommended but won't block publishing. Pinterest also has occasional temporary errors that clear up on retry.",
    commonCauses: [
      "Pinterest isn't connected, or the connection has expired.",
      "No board is selected for the Pin.",
      "The Pin has no usable image.",
    ...
    whatToTry: [
      ...
      "Upload a usable image if the current one is missing or unavailable.",
  ...
  },
  {
    ...
    whatToTry: [
      ...
      "A scheduled Pin still needs a usable image and a Pinterest board. Copy and alt text can be completed later.",
    ],
