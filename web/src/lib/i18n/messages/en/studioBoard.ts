export const studioBoardMessages = {
  ...
  "studioBoard.toast.completeDetailsToSchedule": "Complete the Pin details (title, description, alt text and board) to schedule it.",
  ...
  "studioBoard.toast.completeDetailsToPublish": "Complete the Pin details to publish it.",
