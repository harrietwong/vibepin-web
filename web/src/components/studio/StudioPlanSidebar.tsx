      ...
      {open && (
        <aside data-testid="studio-plan-sidebar" data-pinned={pinned ? "true" : "false"}
          ...
          <footer style={{ padding: 10, borderTop: `1px solid ${BUI.border}`, display: "flex", gap: 8 }}>
            <Link href="/app/studio?view=plan" style={{ flex: 1, textAlign: "center", padding: "8px 10px", borderRadius: 8, border: `1px solid ${BUI.border}`, color: BUI.text, textDecoration: "none", fontSize: 11.5, fontWeight: 700 }}>Open full planner</Link>
          </footer>
        </aside>
      )}
    </>
