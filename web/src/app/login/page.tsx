    ...
    <div className="public-auth-page min-h-screen flex flex-col" style={{ background: "var(--public-bg)" }}>
      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">{copy.title}</p>

          {error && (
            <div className="rounded-xl bg-red-50 border border-red-100 px-4 py-3 mb-5 text-sm text-red-600">
              {error}
            </div>
          )}
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white py-3 text-[14px] font-semibold text-gray-700 hover:bg-gray-50 transition-all disabled:opacity-60 mb-5"
          >
