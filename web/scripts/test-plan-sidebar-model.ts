...
test("a partial fan-out success counts as posted, never failed", () => {
  ...
  const partial = draft({
    ...
    destinationResults: [
      { destinationId: "pinterest:c1", provider: "pinterest", socialConnectionId: "c1", status: "published", publishedAt: "2026-08-26T09:01" },
...
test("an all-destinations-failed content is failed", () => {
  const failed = draft({
    ...
    destinationResults: [
      { destinationId: "pinterest:c1", provider: "pinterest", socialConnectionId: "c1", status: "failed", errorMessage: "rate limited" },
    ],
  });
...
test("providers come from explicit destinations, deduped and ordered", () => {
  const multi = draft({
    ...
    scheduledDestinations: [
      { provider: "pinterest", socialConnectionId: "c1", boardId: "b1", capturedAt: "2026-08-25T00:00:00.000Z" },
      { provider: "instagram", socialConnectionId: "ig1", capturedAt: "2026-08-25T00:00:00.000Z" },
      { provider: "instagram", socialConnectionId: "ig2", capturedAt: "2026-08-25T00:00:00.000Z" },
      { provider: "facebook", socialConnectionId: "p1", capturedAt: "2026-08-25T00:00:00.000Z" },
    ],
  });
