...
- Task 7: implemented on isolated branch `codex/video-pin-p0-task7`; independent Round 1 review found eight Important lifecycle/recovery issues and repair is in progress. Not integrated.
- Task 8: not started.
